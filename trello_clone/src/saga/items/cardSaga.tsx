...
import { CREATE_CARD, DELETE_CARD, FIND_ALL_CARDS, FIND_CARD_BY_ID, UPDATE_CARD, UPDATE_CARD_NAME, UPDATE_CARD_TEST, UPDATE_DATE, UPDATE_DESCRIPTION, UPDATE_STATUS } from "../../api/services/cardServices";
import { getAllCards, getCardById } from "../../redux/reducers/cardSlice";
import { CardDB, CardForm, CardPatch, CardPatchTest, CardUpdateDate, CardUpdateDescription, CardUpdateName, CardUpdateStatus } from "../../types/Card.type";
...
export const updateCardName = function* ({payload}: PayloadAction<CardUpdateName>) {
  try {
