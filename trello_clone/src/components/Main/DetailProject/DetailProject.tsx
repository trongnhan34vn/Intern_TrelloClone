...
export default function DetailProject() {
  ...
  return (
    <div style={{backgroundImage: `url("${getBackgroundURL()}")`}} className="flex bg-no-repeat bg-cover bg-center flex-col flex-1 pl-[260px] h-[calc(100vh_-_64px)] overflow-y-auto">
