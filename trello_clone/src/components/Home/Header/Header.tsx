        ...
        <header className='w-full text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-neutral-600'>
            ...
            <div className="min-h-screen bg-gradient-to-r from-violet-500 to-fuchsia-500 w-full">
                <div className='w-[1200px] mx-auto flex gap-7 py-14 px-10'>
                    <div className=''>
                        <h1 className='leading-tight font-bold text-5xl mb-4 text-white'>Trello tập hợp tất cả nhiệm vụ, thành viên nhóm và công cụ của bạn lại với nhau</h1>
                        <p className='text-xl text-white mb-10'>Duy trì mọi thứ ở cùng một nơi — dù cho nhóm của bạn không ở cùng nhau.</p>
                        <form action="">
                            <input type="text" placeholder='Email' className='mb-4 w-3/4 block px-4 outline-none py-4 rounded-sm' />
                            <button
                                type="button"
                    ...
                    <div className='w-[58,33%]'>
                        <img className='w-full h-auto' src="https://images.ctfassets.net/rz1oowkt5gyp/75rDABL8fyMtNLlUAtBxrg/c5e145977a86c41c47e17c69410c64f7/TrelloUICollage_4x.png?w=2280&fm=webp" alt="" />
                    </div>
                </div>
            </div>
